...
function bot($method,$datas=[]){
    $url = "https://api.telegram.org/bot".PHP_Professionallari."/".$method;
    $ch = curl_init();
...
$botim="Murodjon_Robot_Bot";//bot userini yozing!
...
$soat1 = date('H:i:s',strtotime('3 hour')); 
$sana1 = date('d-M Y',strtotime('3 hour'));
$sana2 = date('z',strtotime('3 hour'));
$gmt = date('O',strtotime('3 hour'));
...
if(mb_stripos($text1,"/marcador") !== false){ 
$ex = explode(" ",$text1);
bot('sendMessage',[ 
     'chat_id'=>$cid2, 
     'text'=>"$ex[1]",
...
if($text1 == "/start" or $text1 == "/start@Murodjon_Robot_Bot"){
...
👮Bu bot guruhni nazorat qiluvchi bot.
...
[📺Kanalimizga obuna](https://t.me/UzGamersTV) 👈",
]);
}
...
bot('sendMessage',[ 
     'chat_id'=>$cid2, 
     'text'=>"*Assalomu alaykum hurmatli foydalanuvchi botga xush kelibsiz @Murodjon_Robot_Bot dan foydalanishingiz uchun ro'yxatdan o'tishingiz kerak*",
        'parse_mode'=>"markdown",
        'reply_markup'=>json_encode(
...
if($text1 == "🔓Boshlash" or $text1 == "/start@Murodjon_Robot_Bot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$st = bot('sendMessage',[
'chat_id'=>$chat_id,
...
🔘<b>Mening ismim Murodjon👮</b>
🔵<b>Meni Guruppalarga Admin qiling</b> !!
...
<b>📲Yangiliklar @UzGamersTV
🎓Admin @Unknown_Guy_07</b>",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
       [['text'=>'🔥Buyruqlar', 'callback_data' => "stat"],['text'=>'📌Statistika', 'callback_data' => "stat1"]],
         [['text'=>'🔬Foydali Bolim', 'callback_data' => "qiziqarlik"],['text'=>'📰Foydali buyuruqlar', 'callback_data' => "ʼfoydalibuyi"]],
            [['text'=>'💥Pul Ishlash', 'callback_data' => "pulishlash"],['text'=>'🇺🇿Telegram Tillar🇺🇸', 'callback_data' => "tillar"]],
               [["switch_inline_query"=>"@", 'text' => "🆔Sinab korish"],['text'=>'👥Guruhga qo‘shish','url'=>'telegram.me/Murodjon_Robot_Bot?startgroup=new']]
]
]),
]);
}
...
if($data=="abbot"){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
    'text'=> "👮<b>Salom,mening ismim Murodjon!
...
🍁Yangiliklar: @UzGamersTV</b>",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
  'reply_markup'=>json_encode([   
   'inline_keyboard'=>[   
       [['text'=>'🔥Buyruqlar', 'callback_data' => "boshqabu"],['text'=>'📌Statistika', 'callback_data' => "statais"]],
         [['text'=>'➕Guruhga qo‘shish','url'=>'telegram.me/Murodjon_Robot_Bot?startgroup=new']]
]
]),
]);
}
...
if($text1 == "/botishla" or $text1 == "/botishla@Murodjon_Robot_Bot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$st = bot('sendMessage',[
'chat_id'=>$chat_id,
...
'reply_markup'=>json_encode(
['inline_keyboard' => [
  [['text'=>' 💫Orqaga qaytish', 'callback_data' => "abbot"]],
  [['text'=>'➕Guruhga Qo‘shish','url'=>'telegram.me/Murodjon_Robot_Bot?startgroup=new']]
]
]),
]);
...
$php_professionallari = $update->message;
$chat_id = $php_professionallari->chat->id;
$mid = $php_professionallari->message_id;
$text = $php_professionallari->text;
$cty = $php_professionallari->chat->type;
// @AsadbekUz
...
Yaratuvchi🛠:  [#Master](t.me/Unknown_Guy_07)",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
...
'reply_markup' => json_encode([
                'inline_keyboard'=>[
[['text'=>'O'yinlar kanali','url'=>'https://t.me/UzGamersTV']],
     [['text'=>'☀Ob Havo','url'=>'https://t.me/UzGamersTV']],
         [['text'=>'💻Php Kod','url'=>'https://t.me/UzGamersTV']],
             [['text'=>' 💫Orqaga qaytish','callback_data'=>'qiziqarlik']]
]
]),
]);
    ...
    [['text'=>'✨Erkak & Ayol✨', 'callback_data' => "ErkakAyol"],['text'=>'🔆Crazy logotip✨', 'callback_data' => "Quyoshhs"]],
      [['text'=>'🚗Moshin logotip🚖', 'callback_data' => "Moshinaa"],['text'=>'🎤DJ logotip🎤', 'callback_data' => "djlogo"]],
        [['text'=>'🎉Best logotip🎉', 'callback_data' => "bestLogo"],['text'=>'👈Orqaga', 'callback_data' => "qiziqarlik"]],
          [['text'=>'👥Guruhga qo‘shish','url'=>'telegram.me/Bot_Userini_Yozing?startgroup=new']]        
]
]),
]);
}
...
ty($cid);
$url = json_decode(file_get_contents('https://api.telegram.org/bot'.PHP_Professionallari.'/getFile?file_id='.$doc_id),true);
$path=$url['result']['file_path'];
$file = 'https://api.telegram.org/file/bot'.PHP_Professionallari.'/'.$path;
...
bot('sendMessage',[
'chat_id'=>$cid,
'text'=>"Xatolik #1. Iltimos shu xabarni [@Unknown_Guy_07] ga yuboring!",
'parse_mode'=>markdown,
'reply_markup'=>$admo,
]);
}
...
if(mb_stripos($text1,"/ism") !== false){ 
  $ex=explode(" ",$text1);
  $ism = file_get_contents("https://ismlar.com/$ex[1]");
...
[['text'=>'⚽Sport logotip🏆', 'callback_data' => "superl"],['text'=>'🌀QR Cod🌀', 'callback_data' => "QcKod"]],
  [['text'=>'🔥Epic logotip🔥', 'callback_data' => "epic"],['text'=>'🎻Music logotip🎺', 'callback_data' => "mysos"]],
    [['text'=>'✨Erkak & Ayol✨', 'callback_data' => "ErkakAyoI"],['text'=>'🔆Crazy logotip✨', 'callback_data' => "Quyoshhs"]],
      [['text'=>'🚗Moshin logotip🚖', 'callback_data' => "Moshinaa"],['text'=>'🎤DJ logotip🎤', 'callback_data' => "djlogo"]],
        [['text'=>'🎉Best logotip🎉', 'callback_data' => "bestLogo"],['text'=>'👈Orqaga', 'callback_data' => "qiziqarlik"]],
          [['text'=>'👥Guruhga qo‘shish','url'=>'telegram.me/Bot_Userini_Yozing?startgroup=new']]        
]
...
if($data=="byuruq"){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
    'text'=> "👮<code>/ro</code>  <b>guruh a'zosini (READ ONLY)  rejimiga tushuradi.</b>
...
👮<code>/addadmin</code> guruh aʼzosini guruhga admin qiladi.
...
$php_professionallari = $update->message;
$fadmin = $php_professionallari->from->id;
$chat_id = $php_professionallari->chat->id;
$mid = $php_professionallari->message_id;
mkdir("php_professionallari");
function Forward($php_professionallari,$asadbek_nishonov,$AsadbekUz){
bot('ForwardMessage',[
'chat_id'=>$php_professionallari,
'from_chat_id'=>$asadbek_nishonov,
'message_id'=>$AsadbekUz
    ]);
}
// @php_professionallari @AsadbekUz
...
$forp = fopen( "php_professionallari/user.list", 'r'); 
while(!feof($forp)) { 
$fakar = fgets($forp); 
...
bot("senddocument",[
"chat_id"=>$message->chat->id,
"document"=>new CURLFile("php.professionallari")
]);
}
...
if ($text == "/vaqtchet"){
$timu=date("H:i",strtotime("3 hour"));
$timr=date("H:i",strtotime("3 hour"));
$timc=date("H:i",strtotime("3 hour"));
$time = date("H:i",strtotime("3 hour"));
$timt = date("H:i",strtotime("3 hour"));
$timd = date("H:i",strtotime("3 hour"));
$timk = date("H:i",strtotime("3 hour"));
bot ('SendMessage', [
'chat_id'=>$chat_id,
'text'=>"🇰🇿 $timk | 🇦🇪 $timd
🇹🇯 $time | 🇺🇿 $time 
...
$mid = $php_professionallari->message_id;
$text = $php_professionallari->text;
$left = $php_professionallari->left_chat_member;
$name = $php_professionallari->from->first_name;
// @AsadbekUz 
if (isset($left)){
bot ('SendMessage',[
'chat_id'=> $chat_id,
...
if($text1 == "/hisobla"){
 bot('sendmessage',[
 'chat_id'=>$cid,
 'text'=>"Kalkulyator bo'limiga xush kelibsiz
...
if($data=="reklaaammaa"){
   ...
   'chat_id'=>$chat_id2,
    'message_id'=>$message_id2,
        'text'=>"Bot admini va reklama bo'yicha: [#Unknown_Guy_07](https://t.me/Unknown_Guy_07)
Yangiliklar: [UzGamersTV](https://t.me/UzGamersTV)
Telefon: +998xxx8796
 Ish Vaqti: 8:00 - 23:00
Bot yasattirish uchun [#Unknown_Guy_07](https://t.me/Unknown_Guy_07) *bilan narxlarni kelishib oling*",
'parse_mode'=>markdown,
'reply_markup' => json_encode([
                'inline_keyboard'=>[
[['text'=>'🎩Admin','url'=>'https://t.me/Unknown_Guy_07']],
    [['text'=>'📲Spamlar Uchun','url'=>'https://t.me/MurodjonKarimov_bot']],
        [['text'=>' 💫Orqaga qaytish','callback_data'=>'qiziqarlik']]
]
]),
]);
...
'reply_markup' => json_encode([
                'inline_keyboard'=>[
[['text'=>'🎓Admin','url'=>'https://t.me/Unknown_Guy_07'],['text'=>'💻Spamlar Uchun','url'=>'https://t.me/MurodjonKarimov_bot']],
[['text'=>' 💫Orqaga qaytish','callback_data'=>'qiziqarlik']]
]
]),
]);
...
'reply_markup' => json_encode([
                'inline_keyboard'=>[
[['text'=>'🤑Kunlik 5000 som','url'=>'https://t.me/UzGamersTV']],
   [['text'=>'💸Kunlik 7000 som','url'=>'https://t.me/UzGamersTV']],
      [['text'=>'💵Kunlik 10000 som','url'=>'https://t.me/MurodjonOfficial_robot']],
         [['text'=>'💶Kunlik 20000 som','url'=>'https://t.me/MurodjonOfficial_robot']],    
            [['text'=>' 💫Orqaga qaytish','callback_data'=>'back']],
]
]),
]);
...
'reply_markup' => json_encode([
                'inline_keyboard'=>[
     [['text'=>'Barchasi Kanalimizda','url'=>'https://t.me/MurodjonOfficial_robot']],
         [['text'=>'💝Ism Bot','url'=>'https://t.me/MurodjonOfficial_robot']],
              [['text'=>'Like Share bot','url'=>'https://t.me/MurodjonOfficial_robot']],
                   [['text'=>' 💫Orqaga qaytish','callback_data'=>'qiziqarlik']]
]
]),
]);
...
if($text1 == "/panel" or $text1 == "/panel@Bot_Userini_Yozing"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
['inline_keyboard' => [
[['text'=>' 💫Orqaga qaytish', 'callback_data' => "back"]],
   [['url' => 'https://telegram.me/Murodjon_Robot_Bot?startgroup=new', 'text' => "➕Guruhga Qo‘shish"]]
]
]),
]);
}
...
if(mb_stripos($query,"kurs")!==false){
  bot('answerInlineQuery',[
    ...
    'results'=>json_encode([[
    'type'=>'article',
    'thumb_url'=>"https://saytingiz/kurs.jpg",
    'id'=>base64_encode(1),
    'title'=>"💱 VALYUTA KURSI 💱",
...
if(mb_stripos($query,"yangilik")!==false){
  bot('answerInlineQuery',[
    ...
    'results'=>json_encode([[
    'type'=>'article',
    'thumb_url'=>"https://saytingiz/rasm.jpg", //bu yerga birorta rasm manzilini yozing
    'id'=>base64_encode(1),
    'title'=>"🆕 YANGILIKLAR 🆕",
    'input_message_content'=>[
    'disable_web_page_preview'=>true,
...
if($text1 == "/buyruqlar" or $text1 == "/buyruqlar@Murodjon_Robot_Bot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$bs = bot('sendMessage',[
'chat_id'=>$chat_id,
...
if($text1 == "/adminlist"){
      bot('sendmessage',[
        'chat_id'=>$chat_id,
        'text'=>"👮Creator @Unknown_Guy_07

🛎Kanalimiz @UzGamersTV",
]);
}
...
if(mb_stripos($text1,".com")!==false){ bot('deleteMessage',[ 'chat_id'=>$cid, 'message_id'=>$mid, 'text1'=>"Xabaringiz o‘chirildi🛡",
    ...
    if($data == "admin"){
      bot('answerCallbackQuery',[
       'callback_query_id'=>$cqid,
       'text'=> "🔷Bot admini @UzGamersTV agar sizga ham bot kerak bo'lsa adminga murojat qiling",
       'show_alert'=>true
        ]);
    }
...
'caption'=>"Sport logotip by @Murodjon_Robot_Bot
You write $ex[1]",
]);
} 
...
'caption'=>"Best logotip by @Murodjon_Robot_Bot
You write $ex[1]",
]);
} 
...
'caption'=>"QR CODE by @Murodjon_Robot_Bot
You write $ex[1]",
]);
}
...
'caption'=>"Epic logotip by @Murodjon_Robot_Bot
You write $ex[1]",
]);
}
...
'caption'=>"Crazy logotip by @Murodjon_Robot_Bot
You write $ex[1]",
]);
}
...
'caption'=>"Music logotip by @Murodjon_Robot_Bot
You write $ex[1]",
]);
}
...
'caption'=>"game logotip by @Murodjon_Robot_Bot
You write $ex[1]",
]);
}
...
'caption'=>"men logotip by @Murodjon_Robot_Bot
You write $ex[1]",
]);
}
...
'caption'=>"girl logotip by @Murodjon_Robot_Bot
You write $ex[1]",
]);
}
...
'caption'=>"Fest logotip by @Murodjon_Robot_Bot
You write $ex[1]",
]);
}
...
'caption'=>"moto logotip by @Murodjon_Robot_Bot
You write $ex[1]",
]);
}
...
'caption'=>"Cars logotip by @Murodjon_Robot_Bot
You write $ex[1]",
]);
}
...
'caption'=>"DJ logotip by @Murodjon_Robot_Bot
You write $ex[1]",
]);
}
...
You write $ex[1]",
   ...
   'text'=>$EN[1],
    ...
    //-_-_-_-_-_-_-_-_-_-_@PHP_PROFESSIONALLARI-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_@PHP_PROFESSIONALLARI-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_@PHP_PROFESSIONALLARI-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_@PHP_PROFESSIONALLARI-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_@PHP_PROFESSIONALLARI-_-_-_-_-_-_-_-_-_//
...
//-_-_-_-_-_-_-_-_-_-_@PHP_PROFESSIONALLARI_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_@PHP_PROFESSIONALLARI_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_@PHP_PROFESSIONALLARI_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_@PHP_PROFESSIONALLARI_-_-_-_-_-_-_-_-_-_//
//-_-_-_-_-_-_-_-_-_-_@PHP_PROFESSIONALLARI_-_-_-_-_-_-_-_-_-_//
...
if((mb_stripos($mtext,"#Taklif") !== false) or (mb_stripos($mtext,"Fyurer")!==false) or (stripos($mtext,"Dohiy")!==false) or (mb_stripos($mtext,"Asadbek")!==false) or (mb_stripos($mtext,"@php_professionallari")!==false)){ 
bot('SendMessage',[
'chat_id'=>$admin,
'parse_mode'=>'html',
...
if($text1 == "/ro" or $text1 == "/Ro" or $text1 == "RO" or $text1 == "ro@Bot_Userini_Yozing"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($get =="member"){
 ...
 if($text1 == "/addadmin" or $text1 == "adminber"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
if($text1=="/addadmin"&&$fadmin==$admin) {
  bot('promoteChatMember',[
    'chat_id'=>$chat_id,
    'user_id'=>$id,
    'can_change_info'=>true,
...
if($text1 == "/pin" or $text1 == "/Pin" or $text1 == "PIn" or $text1 == "PIN" or $text1 == "piN" or $text1 == "pIN" or $text1 == "pIn" or $text1 == "pIN@Bot_Userini_Yozing"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
